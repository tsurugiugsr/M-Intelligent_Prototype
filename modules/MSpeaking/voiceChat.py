...
wsParam = Ws_Param(APPID='a73d2cf6', APISecret='MGY4YmQ1ZTJmMmM4YWE4MzU0ZGRlN2E0',
                    APIKey='c331e4ac15d4b9d57ede0fe701df57ec',
                    Text="")
...
def iFlyTTS(textInput):
    # 测试时候在此处正确填写相关信息即可运行
    wsParam.setText(textInput)
